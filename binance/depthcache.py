...
class DepthCache(object):
    ...
    def get_bids(self):
        ...
        return DepthCache.sort_depth(bids, reverse=True, conv_type=self.conv_type)
    ...
    def get_asks(self):
        ...
        return DepthCache.sort_depth(asks, reverse=False, conv_type=self.conv_type)
    ...
    def get_depth(self):
        ...
        sorted_bids = DepthCache.sort_depth(bids, reverse=True, conv_type=self.conv_type)
        sorted_asks = DepthCache.sort_depth(asks, reverse=False, conv_type=self.conv_type)
